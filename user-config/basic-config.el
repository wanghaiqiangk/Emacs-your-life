...
(use-package evil
  ...
  (define-key evil-normal-state-map (kbd "<leader>cr") 'eglot-rename)
  ...
  (define-key evil-normal-state-map (kbd "<leader>gg") 'rg)
  (define-key evil-normal-state-map (kbd "<leader>gs") 'rg-kill-current)
