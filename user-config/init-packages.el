...
(setq my-package-list
      '(rustic rust-mode eglot visual-fill-column vterm vterm-toggle anzu gitignore-mode gitignore-templates yaml-mode go-mode dumb-jump which-key syslog-mode systemd solarized-theme helm-rtags helm-descbinds helm-describe-modes use-package-chords diminish use-package rg irony-eldoc benchmark-init ace-mc iedit multiple-cursors tramp rtags rtags-xref company-rtags flycheck-rtags ivy-rtags pinyin-search ace-pinyin beacon ace-window anaconda-mode company helm helm-core irony ivy undo-tree rainbow-delimiters python company-anaconda cmake-ide company-try-hard company-c-headers zeal-at-point neotree diff-hl hl-todo idle-highlight-mode flx-ido flx-isearch smex flx yasnippet-snippets yasnippet cmake-font-lock cmake-mode flycheck-irony projectile flycheck-clang-analyzer flycheck json-mode xclip vlf switch-window markdown-mode highlight-indent-guides gnu-elpa-keyring-update counsel company-irony))
