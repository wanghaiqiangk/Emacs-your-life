...
(setq my-package-list
      '(clang-format magit citre eglot visual-fill-column gitignore-mode yaml-mode go-mode dumb-jump which-key syslog-mode systemd solarized-theme helm-rtags helm-descbinds helm-describe-modes use-package-chords diminish use-package rg benchmark-init ace-mc iedit multiple-cursors tramp rtags rtags-xref company-rtags flycheck-rtags ivy-rtags pinyin-search ace-pinyin beacon ace-window anaconda-mode company helm helm-core ivy undo-tree rainbow-delimiters python company-anaconda cmake-ide company-try-hard company-c-headers zeal-at-point neotree diff-hl hl-todo idle-highlight-mode flx-ido smex flx yasnippet-snippets yasnippet cmake-font-lock cmake-mode projectile flycheck-clang-analyzer flycheck json-mode xclip vlf switch-window markdown-mode highlight-indent-guides gnu-elpa-keyring-update counsel))
